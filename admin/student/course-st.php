      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Trang hiển thị khoá học cho sinh viên</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Toàn bộ khoá học</h4>
                  <p class="card-category">Khoá học mà sinh viên đã đăng ký</p>
                </div>
                <div class="card-body">
