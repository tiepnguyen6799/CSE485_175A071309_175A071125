            ...
            <ul class="nav">
                <li class="nav-item ">
                    <a class="nav-link" href="student.php">
                        ...
                        <p>Trang dành cho sinh viên</p>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" href="exam-st.php">
                        <i class="material-icons">create</i>
                        <p>Đề thi</p>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" href="course-st.php">
                        <i class="material-icons">import_contacts</i>
                        <p>Khoá học</p>
                    </a>
                </li>
                <li class="nav-item active ">
                    <a class="nav-link" href="notification-st.php">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Trang hiển thị thông báo khoá học của sinh viên</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Toàn bộ thông báo</h4>
                  <p class="card-category">Nhưng thông báo của khoá học</p>
                </div>
                <div class="card-body">
