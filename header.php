		...
		<div class="head-responsive">
			...
			<div class="menu">
				...
				<div class="content-responsive">
							<ul>
								<li><a href="#">HOTLINE: 0912.298.300 - 0914.298.300</a></li>
					  ...
					  <div class="collapse navbar-collapse row" id="navbarNav">
					    <ul class="navbar-nav ">
					      ...
					      <li class="nav-item col">
					        ...
					        <a class="nav-link" href="Nghiencuu.php">Nghiên cứu </a>
					      </li>
					      <li class="nav-item col-3">
					      	<i class="fas fa-handshake"></i>
					        <a class="nav-link" href="Hoptacdoanhnghiep.php">Hợp tác doanh nghiệp</a>
					      </li>
					    </ul>
					  </div>
					</nav>
